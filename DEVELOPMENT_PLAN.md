...
| 2.3 BIP 頁面補充 | High | 已完成 | 2025-12-30 |
| 3.1 行動版 TOC | Medium | 已完成 | 2025-12-30 |
| 3.2 程式碼複製按鈕 | Medium | 已完成 | 2025-12-30 |
| 3.3 搜尋功能 | Medium | 已完成 | 2025-12-31 |
| 3.4 表格無障礙性 | Medium | 已完成 | 2025-12-31 |
| 4.1 ESLint/Prettier | Low | 已完成 | 2025-12-31 |
| 4.2 路徑別名清理 | Low | 已完成 | 2025-12-31 |
| 4.3 測試框架 | Low | 已完成 | 2025-12-31 |
...
- [x] BIP 頁面完整性驗證 (41 頁全部對應)
- [x] 行動版目錄 (MobileTOC) 浮動按鈕與底部滑出面板
- [x] 程式碼區塊複製按鈕 (CodeCopy)
- [x] 搜尋功能 (Pagefind) 支援 Cmd/K 快捷鍵與鍵盤導覽
- [x] 表格無障礙性 (aria-label 與 scope 屬性，79 個檔案約 130 個表格)
- [x] ESLint/Prettier 程式碼風格檢查工具
- [x] 路徑別名清理 (移除 4 個未使用的別名)
- [x] 測試框架 (Vitest + happy-dom，21 個測試案例)
