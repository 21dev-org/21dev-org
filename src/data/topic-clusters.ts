...
export const topicClusters: TopicCluster[] = [
  ...
  },
  {
    ...
    relatedBips: [],
    keywords: ['Nostr', 'NIP', '中繼器', '事件', 'Zaps', 'npub', 'nsec', 'bech32', 'NIP-02', 'NIP-13', 'NIP-18', 'NIP-40', 'NIP-42', 'NIP-44', 'NIP-07', 'NIP-09', 'NIP-10', 'NIP-11', 'NIP-25', 'NIP-46', 'NIP-47', 'NIP-50', 'NIP-51', 'NIP-58', 'NIP-59', 'NIP-65', 'NIP-94', 'NIP-96', 'NIP-98', '加密', '瀏覽器擴充', '遠端簽名', 'Nostr Connect', 'Wallet Connect', 'NWC', '反應', '回覆', '對話串', '刪除', 'Outbox', '搜尋', '檔案上傳', '媒體', 'HTTP認證', 'Bearer', 'blurhash', 'imeta', '閃電網路錢包', '中繼器認證', 'AUTH', '聯絡人', '關注', 'petname', 'kind 3', '列表', '靜音', '書籤', '置頂', '徽章', 'badge', '成就', 'gift wrap', '禮物包裝', 'seal', '密封', '隱私', 'PoW', '工作量證明', 'nonce', '難度', 'expiration', '過期', '時間戳', 'repost', '轉發', '引用'],
  },
];
