...
export const topicClusters: TopicCluster[] = [
  ...
  },
  {
    ...
    relatedBips: [],
    keywords: ['Nostr', 'NIP', '中繼器', '事件', 'Zaps', 'npub', 'nsec', 'bech32', 'NIP-02', 'NIP-13', 'NIP-17', 'NIP-18', 'NIP-21', 'NIP-28', 'NIP-29', 'NIP-30', 'NIP-32', 'NIP-36', 'NIP-38', 'NIP-40', 'NIP-42', 'NIP-44', 'NIP-07', 'NIP-09', 'NIP-10', 'NIP-11', 'NIP-25', 'NIP-46', 'NIP-47', 'NIP-50', 'NIP-51', 'NIP-53', 'NIP-56', 'NIP-58', 'NIP-59', 'NIP-65', 'NIP-75', 'NIP-90', 'NIP-94', 'NIP-96', 'NIP-98', '加密', '瀏覽器擴充', '遠端簽名', 'Nostr Connect', 'Wallet Connect', 'NWC', '反應', '回覆', '對話串', '刪除', 'Outbox', '搜尋', '檔案上傳', '媒體', 'HTTP認證', 'Bearer', 'blurhash', 'imeta', '閃電網路錢包', '中繼器認證', 'AUTH', '聯絡人', '關注', 'petname', 'kind 3', '列表', '靜音', '書籤', '置頂', '徽章', 'badge', '成就', 'gift wrap', '禮物包裝', 'seal', '密封', '隱私', 'PoW', '工作量證明', 'nonce', '難度', 'expiration', '過期', '時間戳', 'repost', '轉發', '引用', 'NSFW', '敏感內容', 'content-warning', '私密訊息', 'private DM', 'rumor', 'nostr: URI', 'njump', '自訂表情', 'custom emoji', 'shortcode', '公開聊天', 'channel', '頻道', '群組', 'relay group', '私密群組', 'DVM', 'data vending machine', '資料販賣機', 'AI', '翻譯', '圖片生成', '舉報', 'report', 'kind 1984', '垃圾訊息', 'spam', '冒充', 'impersonation', '惡意軟體', 'malware', 'labeling', '標籤', 'taxonomy', 'kind 1985', '命名空間', 'namespace', 'user status', '用戶狀態', 'kind 30315', 'music', '音樂', 'general', 'live activities', '直播', 'streaming', 'kind 30311', 'kind 1311', 'live chat', '語音房', 'meeting', 'zap goals', '募資', 'crowdfunding', 'kind 9041', 'fundraising', 'millisats'],
  },
];
