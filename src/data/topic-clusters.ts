...
export const topicClusters: TopicCluster[] = [
  ...
  },
  {
    ...
    relatedPages: [
      ...
      { href: '/tech/nostr/nip-92/', title: 'NIP-92 媒體附件', type: 'tech' },
      { href: '/tech/nostr/nip-27/', title: 'NIP-27 文字引用', type: 'tech' },
      { href: '/tech/nostr/nip-48/', title: 'NIP-48 代理標籤', type: 'tech' },
      { href: '/tech/nostr/nip-70/', title: 'NIP-70 受保護事件', type: 'tech' },
      { href: '/tech/nostr/nip-73/', title: 'NIP-73 外部內容 ID', type: 'tech' },
      { href: '/tech/nostr/nip-99/', title: 'NIP-99 分類廣告', type: 'tech' },
      { href: '/tech/nostr/nip-03/', title: 'NIP-03 OpenTimestamps', type: 'tech' },
      { href: '/tech/nostr/nip-15/', title: 'NIP-15 Nostr 市場', type: 'tech' },
      { href: '/tech/nostr/nip-34/', title: 'NIP-34 Git 協作', type: 'tech' },
      { href: '/tech/nostr/nip-35/', title: 'NIP-35 Torrents', type: 'tech' },
      { href: '/tech/nostr/nip-54/', title: 'NIP-54 Wiki', type: 'tech' },
      { href: '/tech/nostr/nip-55/', title: 'NIP-55 Android Signer', type: 'tech' },
      { href: '/tech/nostr/nip-26/', title: 'NIP-26 委託簽名', type: 'tech' },
      { href: '/tech/nostr/nip-33/', title: 'NIP-33 參數化可替換', type: 'tech' },
      { href: '/tech/nostr/nip-45/', title: 'NIP-45 計數結果', type: 'tech' },
      { href: '/tech/nostr/nip-60/', title: 'NIP-60 Cashu 錢包', type: 'tech' },
      { href: '/tech/nostr/nip-61/', title: 'NIP-61 Nutzaps', type: 'tech' },
    ],
    relatedBips: [],
    keywords: ['Nostr', 'NIP', '中繼器', '事件', 'Zaps', 'npub', 'nsec', 'bech32', 'NIP-02', 'NIP-13', 'NIP-17', 'NIP-18', 'NIP-21', 'NIP-28', 'NIP-29', 'NIP-30', 'NIP-32', 'NIP-36', 'NIP-38', 'NIP-40', 'NIP-42', 'NIP-44', 'NIP-07', 'NIP-09', 'NIP-10', 'NIP-11', 'NIP-25', 'NIP-46', 'NIP-47', 'NIP-50', 'NIP-51', 'NIP-52', 'NIP-53', 'NIP-56', 'NIP-58', 'NIP-59', 'NIP-65', 'NIP-75', 'NIP-84', 'NIP-90', 'NIP-94', 'NIP-96', 'NIP-98', '加密', '瀏覽器擴充', '遠端簽名', 'Nostr Connect', 'Wallet Connect', 'NWC', '反應', '回覆', '對話串', '刪除', 'Outbox', '搜尋', '檔案上傳', '媒體', 'HTTP認證', 'Bearer', 'blurhash', 'imeta', '閃電網路錢包', '中繼器認證', 'AUTH', '聯絡人', '關注', 'petname', 'kind 3', '列表', '靜音', '書籤', '置頂', '徽章', 'badge', '成就', 'gift wrap', '禮物包裝', 'seal', '密封', '隱私', 'PoW', '工作量證明', 'nonce', '難度', 'expiration', '過期', '時間戳', 'repost', '轉發', '引用', 'NSFW', '敏感內容', 'content-warning', '私密訊息', 'private DM', 'rumor', 'nostr: URI', 'njump', '自訂表情', 'custom emoji', 'shortcode', '公開聊天', 'channel', '頻道', '群組', 'relay group', '私密群組', 'DVM', 'data vending machine', '資料販賣機', 'AI', '翻譯', '圖片生成', '舉報', 'report', 'kind 1984', '垃圾訊息', 'spam', '冒充', 'impersonation', '惡意軟體', 'malware', 'labeling', '標籤', 'taxonomy', 'kind 1985', '命名空間', 'namespace', 'user status', '用戶狀態', 'kind 30315', 'music', '音樂', 'general', 'live activities', '直播', 'streaming', 'kind 30311', 'kind 1311', 'live chat', '語音房', 'meeting', 'zap goals', '募資', 'crowdfunding', 'kind 9041', 'fundraising', 'millisats', 'calendar', '日曆', 'RSVP', 'kind 31922', 'kind 31923', 'kind 31925', 'geohash', '活動', 'event scheduling', 'highlights', '精選', 'kind 9802', 'annotation', '標記', 'quote', 'NIP-89', 'application handler', '應用處理器', 'kind 31989', 'kind 31990', 'app discovery', '應用發現', 'recommendation', 'handler info', 'NIP-71', 'video', '影片', 'kind 21', 'kind 22', 'short video', '短影音', 'imeta', 'text-track', 'segment', '章節', 'WebVTT', '字幕', 'NIP-39', 'external identity', '外部身份', 'github', 'twitter', 'mastodon', 'telegram', 'identity verification', '身份驗證', 'i tag', 'NIP-72', 'moderated community', '審核社群', 'kind 34550', 'kind 4550', 'kind 1111', 'moderator', '版主', 'approval', '批准', 'community post', 'NIP-78', 'app data', '應用程式資料', 'kind 30078', 'custom data', '自訂資料', 'user preferences', '用戶設定', 'storage', '儲存', 'NIP-06', 'mnemonic', '助記詞', 'BIP-39', 'BIP-32', 'seed phrase', '種子', 'HD wallet', '派生路徑', 'key derivation', 'NIP-22', 'comment', '評論', 'kind 1111', 'threaded', '討論串', 'reply', 'NIP-49', 'ncryptsec', '私鑰加密', 'scrypt', 'XChaCha20', 'password encryption', '密碼加密', 'NIP-92', 'media attachment', '媒體附件', 'imeta', 'image', '圖片', 'video', 'blurhash', 'NIP-27', 'text reference', '文字引用', 'mention', '提及', 'nostr: URI', 'q tag', 'NIP-48', 'proxy tag', '代理標籤', 'bridge', '橋接', 'ActivityPub', 'atproto', 'Bluesky', 'Fediverse', 'RSS', 'cross-platform', 'NIP-70', 'protected event', '受保護事件', '- tag', 'no rebroadcast', '防止轉發', 'exclusive content', '獨家內容', 'paid relay', 'NIP-73', 'external content ID', '外部內容', 'imdb', 'tmdb', 'spotify', 'isbn', 'openlibrary', 'goodreads', 'doi', 'steam', 'igdb', 'geo', 'geohash', 'osm', 'podcast', 'movie', '電影', 'book', '書籍', 'music', '地點', 'NIP-99', 'classified listing', '分類廣告', 'kind 30402', 'for-sale', '出售', 'wanted', '徵求', 'service', '服務', 'job', '工作', 'rental', '租賃', 'marketplace', '交易市場', 'price', '價格', 'NIP-03', 'OpenTimestamps', 'OTS', '時間戳', 'timestamp', 'Bitcoin', '比特幣區塊鏈', 'proof', '證明', 'attestation', 'NIP-15', 'marketplace', '市場', 'stall', '商店', 'product', '商品', 'kind 30017', 'kind 30018', 'e-commerce', '電商', 'shipping', '配送', 'NIP-34', 'git', 'repository', '倉庫', 'patch', '補丁', 'issue', '議題', 'kind 30617', 'kind 1617', 'kind 1621', 'code collaboration', '程式碼協作', 'pull request', 'NIP-35', 'torrent', '種子', 'BitTorrent', 'magnet', 'kind 2003', 'file sharing', '檔案分享', 'tracker', 'info hash', 'NIP-54', 'wiki', '維基', 'kind 30818', 'wikilink', '知識庫', 'article', '文章', 'asciidoc', 'markdown', 'collaboration', '協作', 'NIP-55', 'Android Signer', 'nostrsigner', 'Intent', 'Content Provider', 'Android', '行動簽名', 'sign_event', 'get_public_key', 'encrypt', 'decrypt', 'nip04', 'nip44', 'mobile signer', 'NIP-26', 'delegation', '委託', '委託簽名', 'delegated signing', 'delegation token', 'conditions', '授權', 'NIP-33', 'parameterized replaceable', '參數化可替換', 'd tag', 'naddr', 'kind 30000-39999', 'replaceable event', 'NIP-45', 'COUNT', '計數', 'counting', '統計', 'followers count', 'likes count', 'replies count', 'NIP-60', 'Cashu', 'ecash', '電子現金', 'mint', '造幣廠', 'kind 17375', 'kind 7375', 'kind 7376', 'proof', 'token', 'NIP-61', 'Nutzaps', 'Cashu Zaps', 'kind 9321', 'kind 10019', 'P2PK', '隱私打賞', 'ecash zap'],
  },
];
