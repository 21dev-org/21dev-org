...
export const topicClusters: TopicCluster[] = [
  ...
  },
  {
    ...
    relatedBips: [],
    keywords: ['閃電網路', 'Lightning', 'HTLC', '支付通道', 'BOLT'],
  },
  {
    id: 'nostr',
    name: 'Nostr',
    ...
    relatedPages: [
      ...
      { href: '/tech/nostr/nip-05/', title: 'NIP-05', type: 'tech' },
      { href: '/tech/nostr/nip-57/', title: 'Zaps', type: 'tech' },
    ],
    relatedBips: [],
    keywords: ['Nostr', 'NIP', '中繼器', '事件', 'Zaps'],
  },
];
